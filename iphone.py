...
def edit_iphone(version, textfile):
...
def send_iphone(version, me, password, you):
    # Utworzenie zawartości wiadomości
    msg = MIMEMultipart('related')
    msg['Subject'] = str("Wydanie Google for iPhone " + version)
    msg['From'] = me
    msg['To'] = you

    # Import ciała wiadomości z HTML
    file = abspath('iphone_data/letter_mod.html')
    ...
    s.quit()
    os.remove("iphone_data/letter_mod.html")
    os.remove("temp.txt")